...
def prepare_data(df):
    ...
    # Group by studentId and category, and aggregate scores and performance
...
def save_model(model, mlb, model_filename='motorcycle_performance_classifier.pkl'):
...
def main():
    ...
    file_path = 'PDC Evaluation\motor_scores.csv'
